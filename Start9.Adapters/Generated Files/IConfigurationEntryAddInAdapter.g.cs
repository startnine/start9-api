...
namespace Start9.Api.AddInSideAdapters
{
    ...
    {
        internal static Start9.Api.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(Start9.Api.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
