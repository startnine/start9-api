	...
	public class Planerator : FrameworkElement
	{
		...
		private class LayoutInvalidationCatcher : Decorator
		{
			protected override Size MeasureOverride(Size constraint)
			{
				...
				if (pl != null) pl.InvalidateMeasure();
			...
			{
				var pl = Parent as Planerator;
				if (pl != null) pl.InvalidateArrange();
		...
		public static readonly DependencyProperty FieldOfViewProperty =
			DependencyProperty.Register("FieldOfView", typeof(double), typeof(Planerator), new UIPropertyMetadata(45.0,
		...
		{
			var qx = new Quaternion(_xAxis, RotationX);
			var qy = new Quaternion(_yAxis, RotationY);
			var qz = new Quaternion(_zAxis, RotationZ);
		...
		// Static data
		private static readonly Point3D[] _mesh =
			{new Point3D(0, 0, 0), new Point3D(0, 1, 0), new Point3D(1, 1, 0), new Point3D(1, 0, 0)};

		private static readonly Point[] _texCoords = {new Point(0, 1), new Point(0, 0), new Point(1, 0), new Point(1, 1)};
